...
export let contentList: Content[] = [
  ...
  },
  {
    ...
    para: `My first project was a McDonald's desktop application with WPF .Net Framework & Microsoft SQL Server backend, featuring user login, meal ordering, and an immersive UI reflecting McDonald's motif, combining robust functionality with an engaging user experience.`,
